...
class MedicalRecordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medical_record" do
    assert_difference("MedicalRecord.count") do
      post medical_records_url, params: { medical_record: { current_state: @medical_record.current_state, habits: @medical_record.habits, patient_id: @medical_record.patient_id, patology: @medical_record.patology } }
    end
  ...
  test "should update medical_record" do
    patch medical_record_url(@medical_record), params: { medical_record: { current_state: @medical_record.current_state, habits: @medical_record.habits, patient_id: @medical_record.patient_id, patology: @medical_record.patology } }
